  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `O cartão "${formData.name}" foi adicionado à sua conta.`,
      })

      // Redirecionar para a página de cartões
      setTimeout(() => {
    ...
    <div className="container mx-auto px-6 py-8">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-600">Adicione um novo cartão à sua conta</p>
        </div>
      </div>
